 ...
 <footer class="main-footer">
     ...
     <div class="pattern-layer-one" style="background-image: url(project/images/background/pattern-12.png)"></div>
     <div class="pattern-layer-two" style="background-image: url(project/images/background/pattern-13.png)"></div>
     <div class="pattern-layer-three" style="background-image: url(project/images/background/pattern-14.png)"></div>
     <div class="pattern-layer-four" style="background-image: url(project/images/background/pattern-13.png)"></div>
             ...
             <div class="row clearfix">
                 ...
                 <div class="footer-column col-lg-5 col-md-12 col-sm-12">
                     <div class="footer-widget logo-widget">
                         <div class="logo">
                             <a href="index.html"><img src="{{asset('project/images/logo.png')}}" alt="" /></a>
                         </div>
                         <ul class="info-list">

<body class="hidden-bar-wrapper">
            ...
            <div class="header-upper">
                <div class="outer-container clearfix">
                    ...
                    <div class="pull-left logo-box">
                        <div class="logo"><a href="index.html"><img src="{{asset('project/images/logo.png')}}" alt="" title=""></a></div>
                    </div>
                        ...
                        <nav class="main-menu navbar-expand-md">
                            ...
                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown has-mega-menu"><a href="#"><span>Courses <i class="fa fa-arrow-down"></i></span></a>
                                        <div class="mega-menu">
                                            ...
                                            <div class="lower-box">
                                                ...
                                                <div class="side-icon">
                                                    <img src="{{asset('project/images/resource/mega-menu-icon.png')}}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li><a href="donation.html">Sign Up</a></li>
                                </ul>
                            </div>
                        </nav>
                        ...
                        <div class="outer-box clearfix">
                            ...
                            <ul class="cart-box">
                                <div class="dropdown">
                                    ...
                                    document.getElementById('logout-form').submit();" class=" cart-box-btn dropdown-toggle"  title="Sign Up" aria-haspopup="true" aria-expanded="false"><i class="fas fa-power-off"></i></a>
                                </div>
    ...
    <div class="sticky-header">
        <div class="auto-container clearfix">
            ...
            <div class="logo pull-left">
                <a href="index.html" title=""><img src="{{asset('project/images/logo.png')}}" alt="" title=""></a>
            </div>
            <!--Right Col-->
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="index.html"><img src="{{asset('project/images/logo.png')}}" alt="" title=""></a></div>
